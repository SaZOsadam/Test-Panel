"""
Django settings for TestPanel project.
...
WSGI_APPLICATION = 'TestPanel.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Example: 'static' is the name of your static files directory.
]
...
LOGIN_REDIRECT_URL = '/quiz/instructor_login/'
